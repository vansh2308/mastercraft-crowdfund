    ...
    return(
        <div className="w-full bg-white h-max border-greywhite rounded-md border-[1px] relative overflow-visible p-10 text-center">
            ...
            <div className="flex justify-between w-full mt-9">
                ...
                <button className="flex gap-5 items-center rounded-full bg-greywhite text-dgrey text-sm font-medium ">
                    <div className="h-full text-lgrey aspect-square p-3 bg-dgrey rounded-full flex items-center justify-center"> 
                        <FaBookmark />
                    </div>
                    <span className="pr-6">Bookmark</span>
                </button>
